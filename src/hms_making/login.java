...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 300, 360));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 360, 770));

        jPanel2.setBackground(new java.awt.Color(0, 51, 51));
        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jPanel2.add(hms_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 310, 290, 30));

        hms_user.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                hms_userKeyReleased(evt);
            }
        });
        jPanel2.add(hms_user, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 240, 290, 30));
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 20, 120, 40));
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 110, 40));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 420, 190, 50));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms_making/user (2).png"))); // NOI18N
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 240, 50, 30));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms_making/padlock.png"))); // NOI18N
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 300, 60, 40));
        ...
        jPanel2.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 420, 220, 50));

        loginerror.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms_making/log-in.png"))); // NOI18N
        jPanel2.add(loginerror, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 10, 280, 90));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 0, 1030, 770));
...
// TODO add your handling code here:
    ...
    private void hms_userKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_hms_userKeyReleased
//String PATTERN="[a-A-ZO-9]{5,30}$";
//pattern pattern = pattern.Compile(PATTERN);

        
        // TODO add your handling code here:
    }//GEN-LAST:event_hms_userKeyReleased
